...
export function Grid({ nodes, onCellClick, isRunning }: GridProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-lg border-2 border-purple-200 p-4 max-w-fit mx-auto">
      ...
      <div className="bg-gradient-to-r from-purple-100 to-pink-100 border-2 border-purple-300 rounded-xl p-3 shadow-md">
        <div className="text-center">
          <h4 className="text-sm font-semibold text-purple-800 mb-2">💜 Quick Guide</h4>
